...
public class Settings {
    ...
    public static final String MAIN_FILE = "http://localhost/3/mainfile.php"; // Ссылка на главный файл
    ...
    public static final String LAUNCHER_FILE_NAME = "MagicWars"; // Имя файла лаунчера
    ...
    public static final byte[] LAUNCHER_KEY = {
